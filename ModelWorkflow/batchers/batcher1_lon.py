from batchers.dataset_constants import TOTAL_SIZE, SIZES, SURVEY_NAMES, MEANS_DICT, STD_DEVS_DICT
...
ROOT_DIR = "/root/Datasets/SelectedClusters/"
DHS_TFRECORDS_PATH_ROOT = ROOT_DIR + "nexus_tfrecords_processed_longevity/"
print(DHS_TFRECORDS_PATH_ROOT)
    ...
    for split in splits:
        for country_year in survey_names[split]:
            ...
            for i in range(TOTAL_SIZE):
                glob_path = f"{DHS_TFRECORDS_PATH_ROOT}{country_year}/{i:05d}.tfrecord.gz"
                tfrecord_paths.append(glob_path)
